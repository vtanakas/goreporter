...
func (s *StrategyInterfacer) Compute(parameters engine.StrategyParameter) (summaries *engine.Summaries) {
...
func (s *StrategyInterfacer) Percentage(summaries *engine.Summaries) float64 {
	return 0.
}
