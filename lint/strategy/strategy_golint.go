...
import (
	...
	"goreporter/lint/linters/golint"
	"goreporter/utils"
)
...
func (s *StrategyLint) Compute(parameters engine.StrategyParameter) (summaries *engine.Summaries) {
...
func (s *StrategyLint) Percentage(summaries *engine.Summaries) float64 {
	summaries.RLock()
